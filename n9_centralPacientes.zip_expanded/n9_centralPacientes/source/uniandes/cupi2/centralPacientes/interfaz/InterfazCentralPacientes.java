...
public class InterfazCentralPacientes extends JFrame
{
    ...
    {
       central.listarLista( );
            central.eliminarPacientesClinicasPorNombresPacientes( "Juan Felipe" );
    ...
    {
        Paciente a = new Paciente( 1, "Juan Felipe", "", "", 1);
        Paciente a1 = new Paciente( 2, "Juan Carlos", "", "", 1);
        Paciente a2 = new Paciente( 3, "Juan Felipe", "", "", 1);
        Paciente a3 = new Paciente( 4, "Juan Andres", "", "", 1);
        Paciente a4 = new Paciente( 6, "Juan Felipe", "", "", 1);

        a.cambiarSiguiente( a2 );
        a2.cambiarAnterior( a );
        a3.cambiarAnterior( a2 );
        a4.cambiarAnterior( a3 );
        
        a2.cambiarSiguiente( a3 );
        a3.cambiarSiguiente( a4 );
        a4.cambiarSiguiente( null );

        InterfazCentralPacientes interfaz = new InterfazCentralPacientes( );
        interfaz.central.agregarPacienteAlFinal( a );
        interfaz.central.agregarPacienteAlFinal( a1 );
        interfaz.central.agregarPacienteAlFinal( a2 );
        interfaz.central.agregarPacienteAlFinal( a3 );
        interfaz.central.agregarPacienteAlFinal( a4 );
